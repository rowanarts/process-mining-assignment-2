...
PATH_DF_PARQUET = '../dataset/BPI_Challenge_df.parquet'  # original log, but saved as .parquet file since it loads much faster.
...
def save_log_original(log_object: pm4py) -> None:
...
def save_log_filtered(log_object: pm4py) -> None:
